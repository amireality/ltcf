...
export default function NotchDemo() {
  ...
  return (
    <div className="relative flex min-h-[500px] w-full translate-z-0 items-center justify-center overflow-hidden rounded-lg bg-neutral-100 dark:bg-neutral-950 [&_.fixed]:absolute">
      <div
        className={cn(
